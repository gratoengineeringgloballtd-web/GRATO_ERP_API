...
mongoose.connect(process.env.MONGO_URI).then(async () => {
  try {
    ...
    const requisition = await PR.findOne({ requisitionNumber: 'REQ202601075320' });
    ...
    if (requisition) {
      console.log('✓ Requisition Found: REQ202601075320');
    ...
    const allCashRequests = require('../models/CashRequest');
