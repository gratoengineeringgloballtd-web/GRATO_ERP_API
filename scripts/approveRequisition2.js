...
mongoose.connect(process.env.MONGO_URI).then(async () => {
  try {
    // Find the budget code - Roll Out Opex 2026
    ...
    const requisition = await PR.findOne({ requisitionNumber: 'REQ202601095763' });
    ...
    if (requisition) {
      console.log('✓ Requisition Found: REQ202601095763');
