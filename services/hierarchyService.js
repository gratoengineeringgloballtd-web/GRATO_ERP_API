...
class HierarchyService {
  ...
  static determineApprovalCapacities(position, department, isHead = false) {
    ...
    // CEO - absolute final authority
    if (position === 'CEO - Final Authority') {
      capacities.push('ceo');
      return capacities;
    }
  ...
  static determineUserRole(position, department, positionData) {
    // CEO role — absolute final authority
    if (position === 'CEO - Final Authority' || positionData?.email === 'tom@gratoengineering.com') {
      return 'ceo';
    }
